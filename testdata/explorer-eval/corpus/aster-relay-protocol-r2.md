...
The Lumen Processor must acknowledge a batch within 70 seconds. If no acknowledgement arrives, the Aster Relay retries the same batch at most six times.
...
Revision r2 replaces the 40-second acknowledgement window and four-retry ceiling from revision r1. The longer window prevents needless duplicates during scheduled low-bandwidth links.
