...
Status: Accepted, normative for `docs/sharkbite-compatibility.md` revision 49.
...
`docs/sharkbite-compatibility-revision49-scope.tsv`:
...
Revision 49 therefore keeps `SB-XCUT-014`, `SB-XCUT-019`, and `SB-PKG-008` as
