...
| SB-CPP-002 | Flat C API `open_table` / `create_table` / `drop_table` / `free_table` (`include/extern/accumulo.h:117-119`) | `CreateTable` / `DeleteTable` (`accumulo/table_admin.go:76,96`) | — | `c-library-examples/python/example.py` | Missing C ABI | Same gap as [§11](#sec-11); tracked by issue [#82](https://github.com/phrocker/shoal-oss/issues/82) / PR [#84](https://github.com/phrocker/shoal-oss/pull/84). |
...
| ID | Gap | Matrix rows | Existing issue/PR | Notes |
| --- | --- | --- | --- | --- |
| SB-GAP-C-001 | Table administration on the ABI | SB-TABLE-001…SB-TABLE-003, SB-TABLE-005, SB-TABLE-007, SB-TABLE-008, SB-TABLE-016…SB-TABLE-019, SB-CPP-002 | [#82](https://github.com/phrocker/shoal-oss/issues/82) / PR [#84](https://github.com/phrocker/shoal-oss/pull/84) | Explicitly deferred today (`capi/README.md`). |
| SB-GAP-C-002 | Capability discovery | SB-XCUT-012 | [#86](https://github.com/phrocker/shoal-oss/issues/86) | Required before a wheel can degrade gracefully. |
