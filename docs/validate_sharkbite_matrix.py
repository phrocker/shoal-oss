...
EXPECTED_METADATA_FIELDS = {
    ...
    "Shoal reference": (
        "`phrocker/shoal-oss` revision 53 is pinned to latest-main merge "
        "`93a950b30d4f8acac5b7fb9f5e23960d929b6893` immediately before matrix serialization"
    ),
...
EXPECTED_DOCUMENT_STATUS_SNIPPETS = (
    ...
    "Revision 53 — closes the exact 28 configuration, credential, connector/session",
...
EXPECTED_SCOPE_MANIFEST_HEADER = (
    "# Revision-53 Sharkbite client-scope disposition manifest.",
    "# Matrix: docs/sharkbite-compatibility.md revision 53.",
    "# Sharkbite source: phrocker/sharkbite@7f2625f74331b0cd4a75dc0484949c40f1409686.",
    "# Shoal source: phrocker/shoal-oss@93a950b30d4f8acac5b7fb9f5e23960d929b6893.",
