...
EXPECTED_DOCUMENT_STATUS_SNIPPETS = (
    ...
    "Revision 49 — closes the semantic package/import/layout/preload rows",
...
EXPECTED_C_ABI_REFERENCED_EXPORTS = 313
